...
from pii_schema_scout import __version__
from pii_schema_scout.core import (
    audit_records,
    read_records,
    render_json,
    render_markdown,
...
from pii_schema_scout.rules import PROJECT_NAME


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog='pii-schema-scout',
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        help='schema text, CSV headers, or data dictionary notes',
    )
    parser.add_argument(
        "--format",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"pii-schema-scout: error: {exc}", file=sys.stderr)
        return 1
